# How To Run CSV 2 SQL #

# Examples In Tests #
> Look for the examples in source tests and unit tests.

## Reference ##
> this is version one below.

```
/**
* can run either MySql or MsSql
*
*/
public class Run_Test_Import_Sql {
	...
	public static void run() {
		char delimiter = '	';
                ...
                // choose a file or directory to import files.
                // if more than one file, it will import them all into the same table
		...
		destinationData.optimiseTextOnly = true; // if false will do ints and dates and more
		...
		destinationData.databaseType = "MsSql"; // [MySql | MsSql]
