# Destination Data Vars #
> What the vars do. This is an older version below. Look at source.
...
public class DestinationData {
	...
	// one can go from varchar->date, varchar->int (instead of text>date=will not work, at least not on mssql)
	...
	// table for records to exist. will create if doesn't exist in schema
	public String table;

	// this only appears in MsSql that I know of. select * from [catalog].[tableSchema].[table]. If there are other methods let me know.
	public String tableSchema;

	// identiy columns to match update instead of insert?
        // if this identity exists and fields match, it will update instead of insert.
