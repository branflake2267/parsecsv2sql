...
public class Run_Import_SurveyData_Long_MsSql {
	...
	public static void run() {
		...
		String file = "C:\\Archive\\parse\\long";
	...
	private static void deleteBogusData() {
		...
		if (destinationData.databaseType.equals("MySql") == true) {
			query = "DELETE FROM nps.wccci_tmp_surveydata_long WHERE (surveytype= '')";
		} else if (destinationData.databaseType.equals("MsSql") == true){
