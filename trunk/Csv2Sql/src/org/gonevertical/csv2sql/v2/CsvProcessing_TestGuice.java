...
import org.gonevertical.csv2sql.data.FieldDataComparator;
...
public class CsvProcessing_TestGuice extends FlatFileProcessing_v2 {
   ...
   * constructor
   */
  public CsvProcessing_TestGuice(SourceData sourceData, DestinationData_v2 destinationData) {
